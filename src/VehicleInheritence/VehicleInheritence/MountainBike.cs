...
{
    /// <summary>
    /// Represents a mountain bike
    /// </summary>
    public class MountainBike : Bicycle, IGear
    {
        #region Fields
        /// <summary>
        ...
        public MountainBike(string manufacturer, string model, float weight, int gears) : base(manufacturer, model, weight)
        {
            Gears = gears;
        }
        #endregion
